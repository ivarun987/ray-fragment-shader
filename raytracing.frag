...
void drawScene(inout Pixel pixel, inout Ray ray, in Sphere sphere, in Plane plane, in Light light) {
    Ray intersection = ray;
    ...
    do {
        ...
        if (id == sphereId) {
            float shadow_factor = computeShadowFactor(intersection, sphere.material, sphere, plane, light);
            material_reflect[n] = sphere.material;
            material_reflect[n].color = computePhongShading(ray, intersection, sphere.material, light, shadow_factor);
        } else if (id == planeId) {
            float shadow_factor = computeShadowFactor(intersection, plane.material, sphere, plane, light);
            material_reflect[n] = plane.material;
            material_reflect[n].color = computePhongShading(ray, intersection, computeCheckboard(intersection.origin, plane), light, shadow_factor);
        } else {
